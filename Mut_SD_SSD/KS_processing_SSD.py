...
for directory in iters:
    os.chdir(f'F:/Simon_Aube/Hausser_2019_reanalysis/Simulations_ADS_Hausser/pythonProject/'
             f'Final_simulations_v2/Mut_SD_SSD/{directory}')
...
os.chdir(f'F:/Simon_Aube/Hausser_2019_reanalysis/Simulations_ADS_Hausser/pythonProject/Final_simulations_v2/Mut_SD_SSD')
...
# Only the comparison with SSD duplicate couples is kept
...
KS_sub.to_csv('KS_modified_SSD.csv')
...
KS_means.to_csv('KS_means_SSD.csv')