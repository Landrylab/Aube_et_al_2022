...
for directory in iters:
    os.chdir(f'F:/Simon_Aube/Hausser_2019_reanalysis/Simulations_ADS_Hausser/pythonProject/'
             f'Final_simulations_v2/Bivariate_SD_WGD_1e5/{directory}')
...
os.chdir(f'F:/Simon_Aube/Hausser_2019_reanalysis/Simulations_ADS_Hausser/pythonProject/Final_simulations_v2/Bivariate_SD_WGD_1e5')
...
# Only the comparison with WGD couples
...
KS_sub.to_csv('KS_modified_1e5.csv')
...
KS_means.to_csv('KS_means_WGD_1e5.csv')
